...
public class SWWorld extends World {
	...
	entityManager.setLocation(BenKenobi.getBenKenobi(iface, this, patrolmoves), myGrid.getLocationByCoordinates(4, 6));
	entityManager.setLocation(BenKenobi.getBenKenobi(iface, this, patrolmoves), myGrid.getLocationByCoordinates(5, 6));
	// R2D2
	...
	entityManager.setLocation(new TuskenRaider(100, "Urrorr'ukr'arhr", iface, this), myGrid.getLocationByCoordinates(2, 3));
	entityManager.setLocation(new TuskenRaider(100, "Rgur'tlr'rauk", iface, this), myGrid.getLocationByCoordinates(2, 5));
	entityManager.setLocation(new TuskenRaider(100, "Gkrror'ukurr", iface, this), myGrid.getLocationByCoordinates(3, 3));
